...
public class Tema4_Ejercicio_8 {
    static void main() {
        // Introducción
        Scanner sc = new Scanner(System.in);
        Random rng = new Random ();
        int numero_usuario = 0;
        int numero_aleatorio = rng.nextInt(100)+1;
        // Desarrollo
        while (numero_usuario != numero_aleatorio) {
            System.out.println("¿Qué número crees que es? (del 1 al 100): ");
            numero_usuario = sc.nextInt();
            if (numero_usuario > 100 || numero_usuario < 1){
