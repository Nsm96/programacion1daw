...
public class Tema3_Ejercicio6 {
    static void main() {
        ...
        if (ingresos_usuario <= 20000 && cantidad_dependientes < 3) {
                ...
                System.out.println("Tienes que pagar un 5% de impuestos, tendrás que pagar: " + total_a_pagar + " €.");
                ...
                total_a_pagar = porcentaje;
                System.out.println("Tienes que pagar un 10% de impuestos, tendrás que pagar: " + total_a_pagar + " €.");
                ...
                total_a_pagar = porcentaje;
                System.out.println("Tienes que pagar un 20% de impuestos, tendrás que pagar: " + total_a_pagar + " €.");
            } else if (ingresos_usuario >= 80000 && cantidad_dependientes <3) {
                porcentaje = ingresos_usuario * treinta_porciento / 100;
                total_a_pagar = porcentaje;
                System.out.println("Tienes que pagar un 30% de impuestos, tendrás que pagar: " + total_a_pagar + " €.");
                ...
                porcentaje = ingresos_usuario * cinco_porciento / 100;
                total_a_pagar = porcentaje;
                System.out.println("Debido a que usted tiene más de 3 dependientes pagará un 5% en vez de un 10% de impuestos, va a pagar: " + total_a_pagar + " €.");
                ...
                total_a_pagar = porcentaje;
                System.out.println("Debido a que usted tiene más de 3 dependientes pagará un 15% en vez de un 20% de impuestos, va a pagar: " + total_a_pagar + " €.");
            } else if ( cantidad_dependientes > 3 && ingresos_usuario > 80000){
                porcentaje = ingresos_usuario * veinticinco_porciento / 100;
                total_a_pagar = porcentaje;
                System.out.println("Debido a que usted tiene más de 3 dependientes pagará un 25% en vez de un 30% de impuestos, va a pagar: " + total_a_pagar + " €.");
        }
        }
    }
